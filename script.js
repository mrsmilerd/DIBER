    ...
    modal.innerHTML = `
        <div class="modal-contenido-elegante">
            ...
            <div class="estado-section">
                ...
                <div class="estado-descripcion" id="estado-descripcion">
                    ${obtenerDescripcionRentabilidad(resultado)}
                </div>
            </div>
            ...
            <div class="trafico-section ${obtenerClaseTrafico(resultado.trafficInsights.trafficCondition)}">
                <div class="trafico-header">
                    ...
                    <span class="trafico-estado">${resultado.trafficInsights.trafficCondition}</span>
                </div>
...
function obtenerDescripcionRentabilidad(resultado) {
    ...
    if (porMinuto >= 20) return 'Excelentes ganancias por minuto';
    if (porMinuto >= 15) return 'Buenas condiciones de rentabilidad';
